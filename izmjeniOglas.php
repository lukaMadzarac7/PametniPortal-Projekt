...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($odabranoMjesto == "mojaAd"){
        ...
        $sql = "UPDATE postedservice SET ServiceAdderID = ?, ServiceName = ?, ServiceDesc = ?, ServicePrice = ?, ServiceCity = ?, ServiceAddress = ?, NudimTrazim = ?, ServiceRegion = ?, ServiceAvailability = ?
        WHERE PostedServiceID = $currentId";
